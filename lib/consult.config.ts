/* ============================================================================
   CONSULT FUNNEL — CLIENT CONFIG: Precision Hair Restoration
   ...
   Layer 1 restriction LIFTED by Joe 2026-08-05; copy still conservative (open Google ticket 2-0708000040012). Device marks ARTAS/NeoGraft/Alma TED authorized.
   ========================================================================== */

export const CONSULT = {
  clientId: 'precision',
  practice: 'Precision Hair Restoration',

  /* GoHighLevel sub-account. The container must carry GHL_PIT_hjbUKd3iQXeSYDw0FE34
     or every booking call 500s while the page still renders. */
  locationId: 'hjbUKd3iQXeSYDw0FE34',
  ...
  calendars: {
    'in-person': 'Lidt0R23JxSqRwChENMy',
    virtual: 'vDUzftm1yWjJPp01dM1p',
  },
  ...
  address: '1608 Walnut St, Suite 1701',
  city: 'Philadelphia, PA 19103',
  officeShort: 'Philadelphia',
  inPersonWhere: 'At the Philadelphia office, 1608 Walnut St, Suite 1701.',
  ...
  phoneDisplay: '(267) 214-5624',
  phoneRaw: '+12672145624',
  phonePlaceholder: '(267) 555-0142',

  siteUrl: 'https://phillyhairmd.com',
  ...
  termsUrl: 'https://phillyhairmd.com/terms-of-service/',
  ...
  postsApi: 'https://phillyhairmd.com/wp-json/wp/v2/posts?per_page=3&_fields=id,link,date,title',

  headline: 'Book your consultation.',
  subhead: '60 minutes with Precision Hair Restoration, in person in Philadelphia or by video. Choose a time below and it is confirmed on the practice calendar straight away.',
  metaDescription: 'Book a 60 minutes consultation with Precision Hair Restoration. In person in Philadelphia or by video.',
...
/* Attribution write-through to the CRM.
   ...
   locations/customFields.readonly. 75 fields were read and matched by
...
export const CONSULT_FIELD_MAP: Record<string, string> = {
  ...
  /* NOT MAPPED, because no field with these keys exists on this sub-account:
     keyword, matchtype, fbclid, msclkid, campaignid, adgroupid.
