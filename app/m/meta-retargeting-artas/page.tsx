...
export const metadata: Metadata = {
  openGraph: { images: [{ url: "https://more.phillyhairmd.com/og/m-meta-retargeting-artas.webp", width: 1200, height: 630, alt: "ARTAS robotic hair restoration consultation at Precision Hair Restoration" }] },
  twitter: { card: "summary_large_image", images: ["https://more.phillyhairmd.com/og/m-meta-retargeting-artas.webp"] },
  title: 'ARTAS® Robotic Hair Restoration | Precision Hair Restoration',
